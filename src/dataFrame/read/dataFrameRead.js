...
exports.readXLSX = exports.readCSV = exports.createDataFrame = void 0;
var fs_1 = __importDefault(require("fs"));
var csv_parser_1 = __importDefault(require("csv-parser"));
var xlsx_1 = __importDefault(require("xlsx"));
var dataFrame_1 = require("../dataFrame");
function createDataFrame(data, columns) {
    return new dataFrame_1.DataFrame(data, columns);
}
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    fs_1.default.createReadStream(filePath)
                        ...
                        .on('end', function () {
                        var df = createDataFrame(data, columns);
                        resolve(df);
                    })
        ...
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    try {
                        ...
                        var sheetData = xlsx_1.default.utils.sheet_to_json(workbook.Sheets[sheetName]);
                        var columns = Object.keys(sheetData[0]);
                        var df = new dataFrame_1.DataFrame(sheetData, columns);
                        resolve(df);
                    }
                    catch (err) {
                        reject(err);
